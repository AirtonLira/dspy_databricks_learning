...
This folder defines all source code for the 'ingestion_raw_ro_bronze' pipeline:
...
* Take a look at the sample under "sample_users_ingestion_raw_ro_bronze.py" to get familiar with the syntax.
